...
namespace JobLandin.Infrastructure.Migrations
{
    ...
    [Migration("20240521184842_CandidatesListContactInfos")]
    partial class CandidatesListContactInfos
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JobLandin.Domain.Entities.Job", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApplicationMethod = 0,
                            CompanyId = 1,
                            CreatedAt = new DateTime(2024, 5, 21, 19, 48, 41, 439, DateTimeKind.Local).AddTicks(7881),
                        ...
                        new
                        {
                            ...
                            ApplicationMethod = 1,
                            CompanyId = 3,
                            CreatedAt = new DateTime(2024, 5, 21, 19, 48, 41, 439, DateTimeKind.Local).AddTicks(7934),
                            Description = "Fusce 11 tincidunt maximus leo, sed scelerisque massa auctor sit amet. Donec ex mauris, hendrerit quis nibh ac, efficitur fringilla enim.",
                            Location = "Abuja",
                            Salary = 1500m,
                            Title = "Data Analyst"
                        ...
                        new
                        {
                            ...
                            ApplicationMethod = 2,
                            CompanyId = 2,
                            CreatedAt = new DateTime(2024, 5, 21, 19, 48, 41, 439, DateTimeKind.Local).AddTicks(7938),
                            Description = "Fusce 11 tincidunt maximus leo, sed scelerisque massa auctor sit amet. Donec ex mauris, hendrerit quis nibh ac, efficitur fringilla enim.",
                            Location = "Port Harcourt",
                            Salary = 2500m,
            ...
            modelBuilder.Entity("JobLandin.Domain.Entities.Candidate", b =>
                {
                    b.HasOne("JobLandin.Domain.Entities.ApplicationUser", "User")
                        .WithOne("Candidate")
                        .HasForeignKey("JobLandin.Domain.Entities.Candidate", "UserId");
