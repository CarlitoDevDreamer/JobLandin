...
namespace JobLandin.Infrastructure.Migrations
{
    ...
    [Migration("20240508134458_NewCompanyEntityJobApplicationMethod")]
    partial class NewCompanyEntityJobApplicationMethod
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JobLandin.Domain.Entities.Job", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApplicationMethod = 0,
                            CompanyId = 1,
                            CreatedAt = new DateTime(2024, 5, 8, 14, 44, 58, 362, DateTimeKind.Local).AddTicks(5390),
                        ...
                        new
                        {
                            ...
                            ApplicationMethod = 1,
                            CompanyId = 3,
                            CreatedAt = new DateTime(2024, 5, 8, 14, 44, 58, 362, DateTimeKind.Local).AddTicks(5441),
                            Description = "Fusce 11 tincidunt maximus leo, sed scelerisque massa auctor sit amet. Donec ex mauris, hendrerit quis nibh ac, efficitur fringilla enim.",
                            Location = "Abuja",
                            Salary = 1500m,
                            Title = "Data Analyst"
                        ...
                        new
                        {
                            ...
                            ApplicationMethod = 2,
                            CompanyId = 2,
                            CreatedAt = new DateTime(2024, 5, 8, 14, 44, 58, 362, DateTimeKind.Local).AddTicks(5445),
                            Description = "Fusce 11 tincidunt maximus leo, sed scelerisque massa auctor sit amet. Donec ex mauris, hendrerit quis nibh ac, efficitur fringilla enim.",
                            Location = "Port Harcourt",
                            Salary = 2500m,
